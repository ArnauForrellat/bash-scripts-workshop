...
#Write a script that asks the user to enter a directory path and then displays the permissions of the directory, the number of files and subfolders it contains and the names of all files and folders inside it.
